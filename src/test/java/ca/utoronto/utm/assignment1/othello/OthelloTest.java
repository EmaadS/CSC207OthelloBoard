...
public class OthelloTest {
    ...
    /**
     * Testing if moves in this othello games are successful or not.
     */
    @org.junit.jupiter.api.Test
    public void testMove() {
        Othello o = new Othello();
        assertTrue(o.move(2, 4));
        assertEquals(OthelloBoard.P1, o.checkMove(2, 4));

        assertTrue(o.move(2, 5));
        assertEquals(OthelloBoard.P2, o.checkMove(2, 5));

        assertTrue(o.move(3, 5));
        assertEquals(OthelloBoard.P1, o.checkMove(3, 5));

        assertTrue(o.move(2, 3));
        assertEquals(OthelloBoard.P2, o.checkMove(2, 3));

        assertTrue(o.move(1, 2));
        assertEquals(OthelloBoard.P1, o.checkMove(1, 2));

        assertTrue(o.move(4, 5));
        assertEquals(OthelloBoard.P2, o.checkMove(4, 5));
    }
